# Nodus: engineering notes

The working document for people editing this codebase. For the overview, the
diagrams and how the whole thing fits together, start at
...
![Detail panel](screens/detail-panel.png)
...
![Phone width](screens/mobile.png)
...
![Real application](screens/real-app.png)
